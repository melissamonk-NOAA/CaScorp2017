...
for all years prior.  The ratio of party/charter estimates to the MM and BB modes was assumed to 
...
the same observer samples the the catch while onboard the vessel and also conducts the dockside 
...
trawl surveys to 
monitor the demersal fish community in the vicinity of the discharge sites as a condition of the  
...
The southern California Coast Water Research Project [SCCWRP](http://www.sccwrp.org/Homepage.aspx) consists of
