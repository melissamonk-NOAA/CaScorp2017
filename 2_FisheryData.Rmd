...
The retained catch for the recreational party/charter mode has been measured
 ...
 observer programs in southern California by Collins and Crooke [-@Collins1975] 
 ...
 1984-1989 (Table \ref{tab:Fleet5_lengthsample}). The length measurements from
  Collins and Crooke [-@Collins1975] are assumed to all be from retained fish. 
...
The index fo relative abundance using the retained-only catch from the onboard observer program
is a separate survey fleet in the base model and has no lenghts associated with it. Covariates 
considered in the full model included *year*, *area* (5 levels), *month* (12 levels), 
and *20 m depth bins* (5 levels). All covariates were specified as categorical variables.
...
\ref{fig:Fleet12_index5_logcpuefit_RecPCOBR}).  The relative CPUE of the retained catch shows a decline
