...
trend since 2008 (Figure \ref{fig:index4_logcpuedata_RecPC}).  An interesting note 
...
until 2013 (Figure \ref{fig:index4_logcpuedata_Sanitation}).  The last three years of the index show an increase in relative abundance.  The final standardized index and log-standard error can be 
