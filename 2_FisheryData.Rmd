...
binomial model (Table 2).  The difference in AIC values for the full model compared to the 
...
was reducd reduced by 38% for 2004 and 2005, and gives reasonable sample sizes. 
...
As of 2003, Onboard Obsever program has taken length measurements for discarded fish.  
...
place (Table \ref{tab:Fleet6_lengthsample}).
...
The index fo relative abundance using the retained-only catch from the onboard observer 
program is a separate survey fleet in the base model and has no lenghts associated with 
...
and Figure \ref{fig:Fleet12_index5_logcpuefit_RecPCOBR}).  The relative CPUE 
...
Sanitation districts that discharge into coastal waters are required to conduct trawls 
to monitor the demersal fish community in the vacinity of the discharge sites 
part of their National Pollutant Discharge Elimination System (NPEDES) permits, issued
...
contrast to the inverse variance weighted index from teh 2005 assessment, trawls from all
...
The Orange County Sanitation District provided trawl data from 1970-2015 (Jeff Armstrong,
 Orange County Sanitation Disrict).  The trawl net is a 7.6 m wide Marinovich, semi-balloon 
...
2, trawl effor was based on a 10 minute tow time.  As of 1985 
...
Eleven stations (T0-T6,T10-T13) sampled in at least 11 year and with California scorpionfish
...
The City of Los Angeles Sanitation District provided trawl data from 1986-2016 (Craig Campbell,
Lost Angeles City).  The City of Los Angeles follows the same sampling protocols as the 
...
of of other hauls at that station. All California scorpionfish encountered were measured to 
...
Twelve stations (stations at 23m, 61m, and 137m for T0,T1,T4,T5), totalling 
...
Loma Ocean Outfall (SD1-SD14) and five stations from the South Bay Ocean Outrall were retained (SD17-21), totalling 1,180 hauls. A tow time of 10 minutes is assumed for all trawls.  All California scorpionfish 
...
Each district measures every fish encountered in the survey.  Orange County Sanitation 
...
of California scorpionfish in those years (Figure \ref{fig:Fleet7_Sanitation_lengthbydistrict}).
 Los Angeles County has has enountered pulses of large numbers of California scorpionfish in 2002,
 2004 and 2005.  Figure \ref{fig:Fleet7_Sanitation_lengthboxplots} shows the distribution of 
 lengths for Califonria scorpionfish by 25 m depth bins and Sanitation District. The median length 
 of fish from the City of Los Angeles trawls is smaller than the other two districts.  However, there are
  only 120 in that depth bin, compared to 1,372 fish in teh 50-74 m depth bin for the City of Los Angeles.
