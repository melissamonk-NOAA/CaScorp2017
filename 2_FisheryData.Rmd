...
but landed in the U.S. were excluded from the commercial catch histories. [California Explores the Ocean](http://library.ucsd.edu/ceo/fishcatchtables/fish-catch-download.html)(CEO) 
...
Estimates of mortality in the party/charter sector were derived from the CPFV 
Logbook data from 1932-2010 and CRFS from 2011-2017.  The party/charter Phone Survey 
...
discard mortality for the PC mode, the annual average weight was applied from lengths 
...
monitor the demersal fish community in the vicinity of the discharge sites as a condition of their National Pollutant Discharge Elimination System (NPDES) permits, issued 
by the Environmental Protection Agency. All sanitation districts holding NPDES permits 
...
Public Utilities Department all encounter California scorpionfish and provided trawl 
data.
...
Twelve stations (stations at 23 m, 61 m, and 137 m for T0, T1, T4, T5), totaling 
...
A series of data fiters were applied to the dataset (Table \ref{tab:Fleet11_SCBSurvey_filter}). 
