...
An under-reporting adjustment reflecting an average 20% of logs not being submitted 
...
linear ramp from the value for 1928 to zero in 1936 for the PC mode and ratios PC 
...
rockfish/cabezon/greenling complex is closed.  Boat identifiers were available for all trips
...
to monitor the demersal fish community in the vicinity of the discharge sites 
...
The Orange County Sanitation District provided trawl data from 1970-2015 (Jeff Armstrong,
 Orange County Sanitation District).  The trawl net is a 7.6 m wide Marinovich, semi-balloon 
...
Loma Ocean Outfall (SD1-SD14) and five stations from the South Bay Ocean Outfall were retained (SD17-21), totaling 1,180 hauls. A tow time of 10 minutes is assumed for all trawls.  All California scorpionfish 
...
of California scorpionfish in those years (Figure \ref{fig:Fleet7_Sanitation_lengthbydistrict}).
 ...
 only 120 in that depth bin, compared to 1,372 fish in the 50-74 m depth bin for the City of Los Angeles 
...
Spatial locations of raw catch rates (in log scale) are shown in 
...
\ref{fig:index5_logcpuefit_NWFSCtrawl}, respectively.  The Q-Q plots shows generally good 
...
end of the time series (Figure \ref{fig:index5_logcpuefit_GillnetSurvey}).  

The survey measured (standard length) every California scorpionfish encountered, totalling 1,130 fish. 
The majority of fish encountered were between 14 and 33 cm total length, with no strong 
trends or paterns in age classes during the time period 
(Figure \ref{fig:fig:Fleet9_GillnetSurvey_lendat_bubflt10mkt2})
...
The southern Calfironia Coast Water Research Project (SCCWRP) consists of
