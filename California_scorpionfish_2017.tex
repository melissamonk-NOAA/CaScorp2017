...
positives. The AIC and values informing selection of the lognormal model
including year and county effects is provided in Table
...
The Onboard Obsever program only measures discarded fish, as of 2003.
...
\emph{area} (5 levels), \emph{month} (12 levels), and \emph{20 m depth
bins} (5 levels). All covariates were specified as categorical
variables. The final model includes A lognormal model was selected by
...
retained catch shwos a decline from 2007-2015, and an increase in 2016.
