...
\begin{figure}[htbp]
\centering
\includegraphics{California_scorpionfish_2017_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\textbf{MRFSS Dockside Private Boat Survey}
...
\ref{tab:Fleet6_RecDD_onboard_filter}.\\
A total of 26,733 drifts for the analysis were retained. Of these, 5,507
encountered scorpionfish, with 3,249 discarding California scorpionfish
and 3,867 retaining California scorpionfish.
...
the subset of observed anglers for a particular drift.

\emph{Onboard Obsever Discarded Catch Index}

tab:Fleet6\_RecDD\_onboard\_aic

tab:Fleet6\_RecDD\_onboard\_index

fig:Fleet6\_index5\_logcpuefit\_RecDD

\emph{Onboard Obsever Discarded Catch Length Composition}

\emph{Onboard Obsever Retained Catch Index}

tab:Fleet12\_RecPC\_onboard\_aic

tab:Fleet12\_RecPC\_onboard\_index

fig:Fleet12\_index5\_logcpuefit\_RecPCOBR
...
data from 1970-2015, and the majority of sampling occurred in Quarter 1
and 3 (Jan-March and July-September). From 1970-1985 Quarter 2, sampling
was based on a 10 minute tow time. As of 1985 Quarter 3 sampling was
based upon a towed distance of 450m. Tow time was missing for
approximately half of the tows from 1985 Quarter 3 to present, and was
...
scorpionfish. Eleven stations (T0-T6,T10-T13) with long time series and
1,490 tows were retained for the analysis .
