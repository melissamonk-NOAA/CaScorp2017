...
\ref{fig:comp_lendat_data_weighting_TA1.8_RecPC}). The length composition of the recreational fleet discards was smaller in teh 1980's 
and hovers around the 10-in minimum size limit in teh 2000's (Figure \ref{fig:comp_lendat_data_weighting_TA1.8_RecDD}).
...
0.57-0.87 (Figure \ref{fig:profile_h_like} and Table \ref{tab:like_profiles}).  
...
and then declines until 2015.  The last two years of the model indicate an increase in spawning output. 
(Figure \ref{fig:ts7_Spawning_biomass_(mt)_with_95_asymptotic_intervals_intervals}). Since 2015, 
the spawning output has been increased due to 
