...
Changes in the bridge model from from SS2 version 1.8 to SS3.24z and SS3.30.03.05.
...
the highest year in the index, with also high uncertainty.  The gillnet survey was 
...
and hovers around the 10-in minimum size limit in the 2000's (Figure \ref{fig:comp_lendat_data_weighting_TA1.8_RecDD}).
...
The sanitation district index was the axis of uncertainty in the 2005 assessment.  
The stock was estimated to be at 80% depletion in 2005 with the sanitation district 
...
available.  Removing the sanitation index and length composition data from the current base model 
