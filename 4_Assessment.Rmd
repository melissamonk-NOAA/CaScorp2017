...
\ref{fig:comp_lendat_data_weighting_TA1.8_RecPC}). The length composition of the recreational fleet discards was smaller in the 1980s 
and hovers around the 10-in minimum size limit in the 2000s (Figure \ref{fig:comp_lendat_data_weighting_TA1.8_RecDD}).
...
\begin{enumerate}
  ...
  \item Remove each index, one at a time
...
length and age composition data.  A model run with default weighting increased the total 
