...
\begin{frame}{Recreational CPFV Logbook Index: Results}
...
\begin{frame}{Recreational Onboard Retained Catch}
...
\includegraphics{r4ss/plots_mod1/comp_lendat_bubflt9mkt2.png} \endcol
 \begincol{.5\textwidth}
\includegraphics{r4ss/plots_mod1/comp_lendat_bubflt10mkt2.png}
\includegraphics{r4ss/plots_mod1/comp_lendat_bubflt11mkt2.png} \endcol
\endcols

\end{frame}

\begin{frame}{Research length and age composition}
...
\endcol
\endcols
 \#2017 assessment \#\#2017 assessment \#\#\#Summary of Data used in the
2017 Assessment
