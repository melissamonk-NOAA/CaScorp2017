...
![Time series of spawning output trajectory (circles and line: median; light broken lines: 95% credibility intervals) for the base case assessment model.  \label{fig:Spawnbio_all}](r4ss/plots_mod1/ts7_Spawning_biomass_(mt)_with_95_asymptotic_intervals_intervals.png)

![Estimated relative depletion with approximate 95\% asymptotic confidnce intervals (dashed lines) for the base case assessment model. \label{fig:RelDeplete_all}](r4ss/plots_mod1/ts9_Spawning_depletion_with_95_asymptotic_intervals_intervals.png)
...
A summary of California scorpionfish exploitation histories for base model is provided as Figure \ref{fig:Phase_all}.
...
![Phase plot of estimated relative (1-SPR) vs. relative spawning biomass for the base case model. The relative (1-SPR) is (1-SPR) divided by 50\% (the SPR target). Relative depletion is the annual spawning biomass divided by the unfished spawning biomass. \label{fig:Phase_all}](r4ss/plots_mod1/SPR4_phase.png)
...
![Equilibrium yield curve for the base case model. Values are based on the 2016 fishery selectivity and with steepness fixed at... \label{fig:Yield_all}](r4ss/plots_mod1/yield1_yield_curve.png)
...
![Summary of data sources used in the base model. \label{fig:data_plot}](r4ss/plots_mod1/data_plot.png)
...
![Length comps, retained, ComHL \label{fig:mod1_1_comp_lenfit_flt1mkt2}](./r4ss/plots_mod1/comp_lenfit_flt1mkt2.png)

![Pearson residuals, retained, ComHL (max=7.96)   
Closed bubbles are positive residuals (observed > expected) and open bubbles are negative residuals (observed < expected). \label{fig:mod1_2_comp_lenfit_residsflt1mkt2}](./r4ss/plots_mod1/comp_lenfit_residsflt1mkt2.png)

![N_EffN comparison, Length comps, retained, ComHL \label{fig:mod1_3_comp_lenfit_sampsize_flt1mkt2}](./r4ss/plots_mod1/comp_lenfit_sampsize_flt1mkt2.png)

![Francis data weighting method TA1.8: ComHL   Suggested sample size adjustment (with 95% interval) for len data from ComHL: 0.197 (0.1179_1.1745)   For more info, see   Francis, R.I.C.C. (2011). Data weighting in statistical fisheries stock assessment models.  Can. J. Fish. Aquat. Sci.  68: 1124_1138.  \label{fig:mod1_4_comp_lenfit_data_weighting_TA1.8_ComHL}](./r4ss/plots_mod1/comp_lenfit_data_weighting_TA1.8_ComHL.png)

![Length comps, retained, ComNet \label{fig:mod1_5_comp_lenfit_flt2mkt2}](./r4ss/plots_mod1/comp_lenfit_flt2mkt2.png)
