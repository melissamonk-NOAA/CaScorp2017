...
ACLs (Table \ref{tab:mnmgt_perform).  CDFW allocated 75% of the ACL to the recreational 
...
Forecasts (Table \ref{tab:Forecast_mod1}) and decision tables 
(Table \ref{tab:Decision_table_mod1}) to be completed 
during and/or after the STAR panel 
