...
June aggregation  was at a sandy area adjacent to the Farnsworth MPAs.
...
[@Love1987].  The same study tagged California scorpionfish and suggests individuals
return to the same 
...
California scorpionfish is not a major target in the recreational fishery.  They are most 
often taken by boat fishermen, but fairly large numbers are caught from 
piers, jettys, and rocky shorelines.  The Commercial Passenger Fishing Vessl (CPFV; also
...
the later 1990's as commercial landings decreased and recreational harvest became a 
...
effort in areas with high encounter rates of cowcod rockfish (PFMC [-@PFMC2002], Table 29). These areas were closed to 
...
than 20 fathoms. The California Rockfish Conservation Area (CRCA) was defined as those ocean waters 
