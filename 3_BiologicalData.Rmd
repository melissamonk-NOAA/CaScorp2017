...
All otoliths collected from the survey were aged
...
scorpionfish otoliths with two age reads (\ref{fig:Fleet8_NWFSCTrawl_ageingerror}).  
...
respectively (Figure \ref{fig:Fleet8_NWFSCTrawl_ageingerror2}).  Two fish with 
